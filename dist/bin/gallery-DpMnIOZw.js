...
import { S as require_react, a as RoseWhite, b as require_jsx_runtime, d as motion, o as BottomNav, t as GoldCornerFrame, u as createLucideIcon } from "./WeddingDecorations-CglGYRWY.js";
import { r as AnimatePresence, t as listWeddingPhotos } from "./supabase-Dau9epql.js";
...
function GalleryPage() {
	...
	const downloadAll = async () => {
		...
		setDownloading(true);
		try {
			const JSZip = (await import("./lib-ChkVRwO_.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))).default;
			const zip = new JSZip();
