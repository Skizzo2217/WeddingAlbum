...
import { C as require_react, a as RoseWhite, d as createLucideIcon, f as motion, o as BottomNav, t as GoldCornerFrame, x as require_jsx_runtime } from "./WeddingDecorations-Bix8aEST.js";
import { r as AnimatePresence, t as listWeddingPhotos } from "./photo-api-DOdzR_88.js";
import { t as X } from "./x-CZwlBgKO.js";
...
function GalleryPage() {
	...
	const downloadAll = async () => {
		...
		try {
			...
			await Promise.all(visiblePhotos.map(async (photo, i) => {
				try {
			...
			const a = document.createElement("a");
			a.href = url;
			a.download = section === "missions" ? "marco-vanessa-missioni.zip" : "marco-vanessa-ricordi.zip";
			a.click();
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			visiblePhotos.length > 0 && !loading && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.button, {
					...
					children: downloading ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" }), " Preparazione ZIP..."] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
						...
						" Scarica ",
						section === "missions" ? "Missioni" : "Ricordi",
						" (",
